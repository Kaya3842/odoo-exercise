...
class ActivityReport(models.Model):
    ...
    def _join(self):
        return """
            ...
            LEFT JOIN crm_customer_request AS cpr ON l.id = cpr.opportunity_id
        """
    ...
    def _where(self):
        ...
        return """
            WHERE
                ...
                OR (m.model = 'crm.customer.request' AND (m.mail_activity_type_id IS NOT NULL OR m.subtype_id = %s))
